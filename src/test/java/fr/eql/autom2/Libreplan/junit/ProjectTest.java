...
public class ProjectTest {
    ...
    public void firstTest() throws InterruptedException {
        ...
        //wait.until(ExpectedConditions.and(ExpectedConditions.attributeContains(By.xpath(projectDetailPage.getTableProjectDetailXPath()), projectDetailPage.getTableProjectDetail().getText(), "DÈtail du projet"), ExpectedConditions.visibilityOfElementLocated(By.xpath(projectDetailPage.getTableProjectDetailXPath()))));
        ...
        //wait.until(ExpectedConditions.attributeToBe(By.xpath(projectDetailPage.getTableProjectDetailXPath()), projectDetailPage.getTableProjectDetail().getAttribute(name), "DÈtail du projet"));
        ...
        assertEquals("DÈtail du projet", projectDetailPage.getTableProjectDetail().getText());
